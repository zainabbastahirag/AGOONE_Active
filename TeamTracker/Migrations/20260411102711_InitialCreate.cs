        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarUrl = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    OrganizationId = table.Column<int>(type: "INTEGER", nullable: true),
                    OrgRole = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Project = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    TaskTicket = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ...
                    ExtraHours = table.Column<double>(type: "REAL", nullable: false),
                    Blockers = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BugsFoundInWork = table.Column<int>(type: "INTEGER", nullable: false),
                    BugsFixed = table.Column<int>(type: "INTEGER", nullable: false),
                    CodeReviewsDone = table.Column<int>(type: "INTEGER", nullable: false),
                    OnTimeDeliveryPct = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    ErrorsLog = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    TechLeadFeedback = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    ManagerFeedback = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    ProgressNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyKpis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonthlyKpis_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyLogs_MemberId_Date",
                table: "DailyLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonthlyKpis_MemberId_Year_Month",
                table: "MonthlyKpis",
